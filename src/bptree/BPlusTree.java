...
public abstract class BPlusTree<K extends Comparable<K>, P> {
	 ...
	 * @throws InvalidDeletionException 
	 */
	//public abstract void merge( Node<K,P> NPrime, K kPrime, Node <K,P> N, Map<Node<K, ?>, NonLeafNode<K, Node<K, ?>>> node2parent) throws InvalidDeletionException, IOException;
