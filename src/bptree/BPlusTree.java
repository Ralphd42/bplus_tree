...
public abstract class BPlusTree<K extends Comparable<K>, P> {
	...
	/**
	 * An {@code InvalidInsertionException} is thrown when a key already existent in
	 * a {@code BPlusTree} is attempted to be inserted again in the
	 * {@code BPlusTree}.
	 * 
	 * @author Jeong-Hyon Hwang (jhh@cs.albany.edu)
	 *
	...
	/**
	 * An {@code InvalidDeletionException} is thrown when a key non-existent in a
	 * {@code BPlusTree} is attempted to be deleted from the {@code BPlusTree}.
	 * 
	 * @author Jeong-Hyon Hwang (jhh@cs.albany.edu)
	 *
	 */
	 ...
	 * 
	 * @return the root {@code Node} of this {@code BPlusTree}; {@code null} if this
	 *         {@code BPlusTree} is empty
	 ...
	 *                                   {@code BPlusTree} is attempted to be
	 *                                   inserted again in the {@code BPlusTree}
	 * @throws IOException               if an I/O error occurs
	 */
	 ...
	 * @throws InvalidDeletionException if a key non-existent in a {@code BPlusTree}
	 *                                  is attempted to be deleted from the
	 *                                  {@code BPlusTree}
	 * @throws IOException              if an I/O error occurs
	 */
